          ...
          {listaProfesionales.map((profesional, index) => (
            <button
              ...
              className={`animate-reveal-up group relative flex w-full flex-col overflow-hidden text-left opacity-0 transition-all duration-500 hover:-translate-y-1.5 ${
                esSeleccionUnica
                  ? "max-w-5xl rounded-[32px] border border-[#d7e6e1] bg-[linear-gradient(135deg,rgba(255,255,255,0.99)_0%,rgba(247,250,249,0.98)_48%,rgba(241,246,245,0.98)_100%)] p-7 shadow-[0_30px_70px_-40px_rgba(28,66,59,0.22)] ring-1 ring-white hover:border-[#9ec9bf] hover:shadow-[0_36px_82px_-44px_rgba(28,66,59,0.28)] sm:p-9 lg:p-10"
                  : "max-w-4xl rounded-[28px] border border-[#cfe3de] bg-[linear-gradient(180deg,rgba(255,255,255,0.98)_0%,rgba(247,250,249,0.98)_100%)] p-7 shadow-[0_22px_54px_-36px_rgba(30,74,67,0.22)] ring-1 ring-white hover:border-[#93c5bb] hover:shadow-[0_28px_64px_-38px_rgba(30,74,67,0.28)] sm:p-8 lg:p-9"
              }`}
            >
              ...
              <div className={`pointer-events-none absolute border border-[#edf4f2] ${esSeleccionUnica ? "inset-[14px] rounded-[26px]" : "inset-[16px] rounded-[22px]"}`} />
                ...
                <div className={`grid gap-6 lg:items-start ${esSeleccionUnica ? "lg:grid-cols-[minmax(0,1.55fr)_minmax(320px,0.95fr)]" : "lg:grid-cols-[minmax(0,1.45fr)_minmax(240px,0.85fr)]"}`}>
                  <div className="max-w-2xl">
                    <div className="flex items-center justify-between gap-4">
                      <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-[#b9d8d0] bg-[linear-gradient(180deg,#f3fbf8_0%,#dff0eb_100%)] text-xl font-bold text-[#1a756a] shadow-[0_14px_30px_-20px_rgba(26,117,106,0.35)] transition-all duration-500 group-hover:border-[#8bc5b9] group-hover:bg-[linear-gradient(180deg,#eff9f6_0%,#d8eee8_100%)]">
                    ...
                    <h2 className={`mt-6 font-semibold tracking-[-0.04em] text-[#163a34] ${esSeleccionUnica ? "text-4xl sm:text-5xl" : "text-3xl sm:text-4xl"}`}>
                      {profesional.nombreProfesional}
                    </h2>
                    <div className="mt-5 inline-flex rounded-2xl border border-[#d6e7e2] bg-[#f5fbf9] px-5 py-3 shadow-[0_10px_24px_-20px_rgba(26,117,106,0.28)]">
                      <p className={`font-semibold text-[#285d56] ${esSeleccionUnica ? "text-xl sm:text-2xl" : "text-lg sm:text-xl"}`}>
                        {profesional.descripcionProfesional}
                      </p>
                    </div>

                    {!esSeleccionUnica && (
                      <p className="mt-5 max-w-2xl text-[15px] leading-7 text-[#59706b]">
                        Selecciona este profesional para revisar su disponibilidad y continuar con la reserva.
                      </p>
                    )}

                    {esSeleccionUnica && (
                      <p className="mt-5 max-w-2xl text-[15px] leading-7 text-[#59706b] sm:text-base">
                        Agenda una atención de forma simple y revisa los horarios disponibles para continuar con tu reserva.
                      </p>
                    )}

                    <div className="mt-7 max-w-sm">
                      <div className="flex items-center justify-between rounded-[22px] bg-[linear-gradient(90deg,#0f5a52_0%,#1b7569_100%)] px-6 py-4 text-white shadow-[0_20px_45px_-28px_rgba(15,90,82,0.55)] transition-all duration-300 group-hover:shadow-[0_24px_55px_-28px_rgba(15,90,82,0.62)]">
                  ...
                  <div className={`relative flex flex-col justify-between border border-[#dce9e5] bg-[linear-gradient(180deg,#fcfefd_0%,#f4f8f7_100%)] shadow-[inset_0_1px_0_rgba(255,255,255,0.9)] ${esSeleccionUnica ? "min-h-[250px] rounded-[28px] p-6" : "min-h-[210px] rounded-[24px] p-5"}`}>
                    {esSeleccionUnica && (
                    ...
                    <div>
                      {esSeleccionUnica && (
                        <div className="mb-5 rounded-[22px] border border-[#dbeae6] bg-[linear-gradient(180deg,#0f3d39_0%,#114842_100%)] p-4 shadow-[0_18px_40px_-30px_rgba(15,61,57,0.42)]">
                          <div className="relative mx-auto flex aspect-[1.05/1] w-full max-w-[180px] items-center justify-center overflow-hidden rounded-[18px] bg-[radial-gradient(circle_at_top,rgba(28,201,194,0.18),transparent_52%),linear-gradient(180deg,rgba(255,255,255,0.04)_0%,rgba(255,255,255,0.01)_100%)]">
                            <Image
